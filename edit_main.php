...
$query="select * from maintenance where id_m=$id";
...
<body>
<a class="btn btn-primary" href="main_view.php">page précédente</a>
...
if(isset($_POST['confirmer'])){
    ...
    $sql="update maintenance set projet=$projet, finalite_projet=$finalite, cout=$cout, budget=$budget, created_at=$date, groupe_trav=$grp ,Taux_eval=$taux, status=$stat where id_m=$id";
$result=$conn->exec($sql);

if($result){
    echo "<script type='text/javascript'>alert('Projet modifié avec succée')</script>";
    echo"<script>window.location.href='main_view.php'</script>";}
    else{
