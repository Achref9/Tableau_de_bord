...
$query="insert into maintenance VALUES (NULL, $projet, $finalite, $cout, $budget , $date , $taux, $grp, $stat)";
...
if ($result!=1) {
	...
	echo"<script type='text/javascript'>alert('Projet ajouté avec succée');window.location='main_view.php'</script>";
}
