...
$requet="select * from maintenance";
...
<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">   
	...
	<hr>
	  ...
	  <br><br><br><br>
	  <form method="post" action="export_main.php">
<a  name="export" href="export_main.php"><button name="export" class="btn btn-success btn-xs" ><i class="fas fa-download"></i>Exporter CSV</button></a>
</form>	
<div class="panel-heading">
		<div class="row">
			...
			<div class="col-md-2" align="right">
				<a href="add_main.php"><button type="button" name="add"  class="btn btn-success btn-xs">Ajouter</button></a>
            </div>
...
<td>
	<?php echo "<a id='delete_id' name='delete' class='btn btn-danger' href='delete_main.php?id=".$ligne['id_m']."'> Supprimer</a> ";?>
</td>
<td><?php echo "<a id='edit_id' name='edit' class='btn btn-primary' href='edit_main.php?id=".$ligne['id_m']."'> Modifier</a> ";?></td>
</form>
</tr>
